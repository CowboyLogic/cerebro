...
describe('getIDEPaths', () => {
  ...
  it('openCode.user is <home>/.opencode', async () => {
    const { getIDEPaths } = await import('../../../src/utils/paths.js');
    expect(getIDEPaths().openCode.user).toBe(path.join('/home/user', '.opencode'));
  });
  ...
  it('copilot.user is ~/.copilot', async () => {
    const { getIDEPaths } = await import('../../../src/utils/paths.js');
    expect(getIDEPaths().copilot.user).toBe(path.join('/home/user', '.copilot'));
  });
